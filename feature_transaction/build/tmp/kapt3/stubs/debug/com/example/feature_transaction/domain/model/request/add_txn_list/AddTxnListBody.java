...
public final class AddTxnListBody {
    ...
    public final com.example.feature_transaction.domain.model.request.add_txn_list.AddTxnListBody copy(int transactionId, int personId, int inviteId, int amount, long payableAmount) {
        return null;
    }
    ...
    public AddTxnListBody(int transactionId, int personId, int inviteId, int amount, long payableAmount) {
        super();
    }
