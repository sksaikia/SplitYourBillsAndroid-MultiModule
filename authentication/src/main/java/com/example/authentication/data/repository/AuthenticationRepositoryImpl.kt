...
class AuthenticationRepositoryImpl @Inject constructor(
    ...
    override suspend fun registerUser(registrationBody: RegistrationBody): Flow<Result<RegistrationResponse>> {
        return flow {
    ...
    override suspend fun loginUser(loginBody: LoginBody): Flow<Result<LoginResponse>> {
        return flow {
            emit(Result.Loading(true))
